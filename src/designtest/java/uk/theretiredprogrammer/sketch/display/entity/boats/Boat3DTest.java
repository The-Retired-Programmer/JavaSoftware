...
public class Boat3DTest extends Application {
    ...
    public void displayBoatRig3D() {
        System.out.println("draw 3D Boat (Hull and Rig)");
        launch(new String[]{});
    }

    @Override
    public void start(Stage stage) {
        BoatHull3D hull = new BoatHull3D();
        ...
        group.getChildren().addAll(hull, rig);
        Scene scene = new Scene(group, WIDTH, HEIGHT, true);
        scene.setCamera(camera);
        initMouseControl(group, scene, stage);
        stage.setTitle("Testing 3D Boat (Hull and Rig");
