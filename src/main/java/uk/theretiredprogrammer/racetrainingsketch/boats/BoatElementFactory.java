 ...
 */
public class BoatElementFactory {

    public static BoatElement createboatelement(JsonObject paramobj, ScenarioElement scenario, CourseLeg courseleg) throws IOException{
        if (paramobj == null) {
            return null;
        }
