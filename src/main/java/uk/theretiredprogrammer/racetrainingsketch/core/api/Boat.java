 ...
 */
package uk.theretiredprogrammer.racetrainingsketch.core.api;
...
import uk.theretiredprogrammer.racetrainingsketch.mark.Mark;
    ...
    public void timerAdvance(int time) {
        ...
        switch (currentMode) {
            ...
            case TURN:
                ...
                break;
            default:
                throw new RuntimeException("Illegal sailing Mode when moving boat");
        }
    }
