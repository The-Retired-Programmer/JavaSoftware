 ...
 */
public class GradientFlowElement extends CoreFlowElement {
     ...
     */
    public GradientFlowElement(JsonObject paramsobj, ScenarioElement scenario) throws IOException {
    ...
    public Angle getMeanFlowAngle() throws IOException {
        return gradient.getMeanFlowDirection();
    }
}
