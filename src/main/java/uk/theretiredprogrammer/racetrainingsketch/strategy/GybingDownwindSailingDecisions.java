 ...
 */
class GybingDownwindSailingDecisions extends SailingDecisions {
    ...
    GybingDownwindSailingDecisions(boolean sailonbestgybe, boolean gybeiflifted, boolean bearawayifheaded,
