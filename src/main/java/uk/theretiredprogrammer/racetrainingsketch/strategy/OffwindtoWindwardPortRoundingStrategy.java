 ...
 */
class OffwindtoWindwardPortRoundingStrategy extends RoundingStrategy {

    private final double clearance;

    OffwindtoWindwardPortRoundingStrategy(double clearance) {
    ...
    private Angle getOffsetAngle(CourseLeg leg) {
        return leg.getAngleofLeg().add(ANGLE90);
    }
