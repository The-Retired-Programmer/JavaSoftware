 ...
 */
abstract class SailingLegStrategy extends SailingStrategy {

    abstract boolean applyRoundingStrategy(CourseLegWithStrategy leg, Boat boat, Angle winddirection);
