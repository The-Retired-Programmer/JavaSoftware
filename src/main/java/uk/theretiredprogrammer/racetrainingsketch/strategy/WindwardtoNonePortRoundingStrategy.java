 ...
 */
class WindwardtoNonePortRoundingStrategy extends RoundingStrategy {

    private final double clearance;

    WindwardtoNonePortRoundingStrategy(double clearance) {
    ...
    void nextTimeInterval(Decision decision, BoatElement boat, CourseLegWithStrategy leg, Angle winddirection) {
        ...
        if (leg.getEndLocation().angleto(boat.getLocation())
            ...
            decision.setMARKROUNDING(winddirection.sub(ANGLE90),ANTICLOCKWISE);
        }
    }
