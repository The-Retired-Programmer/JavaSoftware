...
public abstract class PropertyMap extends PropertyAny {
    ...
    final ObservableMap<String, PropertyAny> propertymap;
    ...
    class Config<P extends PropertyAny, C extends Object> {

        private final String key;
        private final boolean mandatoryparse;
        private final Function<String, P> creator;

        Config(String key, boolean mandatoryparse, Function<String, P> creator) {
            this.key = key;
        ...
        public P getProperty(String messageleader) {
            P property = (P) propertymap.get(key);
            if (property == null) {
                throw new IllegalStateFailure(messageleader + " - missing Property");
            }
            return property;
        }

        public P getProperty() {
            return getProperty("Config - getProperty");
        }
