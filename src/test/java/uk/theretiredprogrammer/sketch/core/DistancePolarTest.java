...
public class DistancePolarTest {
    ...
    public void testCreation2() {
        ...
        DistancePolar instance = new DistancePolar(new Location(0,0), new Location(10,0));
        assertEquals(10,instance.getDistance());
        assertEquals(new Angle(90), instance.getAngle());
        instance = new DistancePolar(new Location(0,0), new Location(0,10));
        assertEquals(10,instance.getDistance());
    ...
    public void testPolar2Location() {
        ...
        res = instance.polar2Location(new Location(0,0));
