...
public class SailingLegTest {
    ...
    public void testBeforemarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(50, 45),
                new Location(50, 50),
                0).orElse(0.0);
    ...
    public void testOnmarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(50, 50),
                new Location(50, 50),
                0).orElse(0.0);
    ...
    public void testBeyondmarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(50, 51),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightBeforemarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(70, 45),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(5.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightOnmarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(70, 50),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightBeyondmarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(70, 51),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftBeforemarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(20, 45),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(5.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftOnmarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(20, 50),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftBeyondmarkAngle0() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(20, 51),
                new Location(50, 50),
                0).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testBeforemarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(45, 50),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(5.0, calcrefdistance, DELTA);
    }
    ...
    public void testBeyondmarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(51, 50),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightBeforemarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(45, 30),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(5.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightOnmarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(50, 30),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightBeyondmarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(51, 30),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftBeforemarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(45, 80),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(5.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftOnmarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(50, 80),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftBeyondmarkAngle90() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(51, 80),
                new Location(50, 50),
                90).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testBeforemarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(40, 40),
                new Location(50, 50),
                45).orElse(0.0);
    ...
    public void testRightBeforemarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(80, 0),
                new Location(50, 50),
                45).orElse(0.0);
        assertEquals(Math.sqrt(200), calcrefdistance, DELTA);
    }
    ...
    public void testRightOnmarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(80, 20),
                new Location(50, 50),
                45).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testRightBeyondmarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(80, 40),
                new Location(50, 50),
                45).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftBeforemarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(20, 70),
                new Location(50, 50),
                45).orElse(0.0);
    ...
    public void testLeftOnmarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(30, 70),
                new Location(50, 50),
                45).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
    ...
    public void testLeftBeyondmarkAngle45() {
        ...
        double calcrefdistance = CurrentLeg.getRefDistance(new Location(35, 70),
                new Location(50, 50),
                45).orElse(0.0);
        assertEquals(0.0, calcrefdistance, DELTA);
    }
